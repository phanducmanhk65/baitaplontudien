...
public class DictionaryCommandline1 {
    ...
    public void showAllWords(Dictionary1 t) {
    ...
    public void dictionaryBasic() throws FileNotFoundException {
        DictionaryManagement1 a = new DictionaryManagement1();
        DictionaryCommandline1 b = new DictionaryCommandline1();
        Dictionary1 c =a.insertFromCommandline();
        b.showAllWords(c);
    }
    ...
    public void dictionarySearcher(DictionaryManagement1 a) throws IOException{
